...
export const metadata: Metadata = {
  title: "LayUp - Elite Sports Betting Predictions | 16.3% ROI",
  description: "Industry-leading sports betting predictions for high rollers, hedge funds, and fan platforms. Machine learning models with proven 16.3% ROI performance.",
  keywords: "sports betting predictions, machine learning models, hedge fund betting, institutional sports betting, NBA predictions, LayUp Analytics",
  metadataBase: new URL("https://layup.io"),
  alternates: {
    canonical: "https://layup.io"
  },
  openGraph: {
    title: "LayUp - Elite Sports Betting Predictions",
    description: "Industry-leading sports betting predictions for high rollers, hedge funds, and fan platforms. Proven 16.3% ROI performance.",
    siteName: "LayUp",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/8353799/pexels-photo-8353799.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "LayUp sports betting analytics dashboard"
      }
    ]
  },
  twitter: {
    ...
    title: "LayUp - Elite Sports Betting Predictions",
    description: "Industry-leading sports betting predictions for high rollers, hedge funds, and fan platforms. Proven 16.3% ROI performance.",
    images: ["https://images.pexels.com/photos/8353799/pexels-photo-8353799.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
